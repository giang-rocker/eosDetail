...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        desc.add_options()
            ...
            ("model,m", po::value<string>(&modelfile)->required()->default_value("share/sfm_shape_16759.bin"),
            ...
            ("edge-topology,e", po::value<string>(&edgetopologyfile)->required()->default_value("share/sfm_16759_edge_topology.json"),
                "file with model's precomputed edge topology")
            ("blendshapes,b", po::value<string>(&blendshapesfile)->required()->default_value("share/expression_blendshapes_16759.bin"),
